    ...
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
          <button
              @click="modals.showModal('create', 'Хотите добавить пользователя?', 'Добавьте пользователя чтобы увидеть его в списке пользователей')"
              type="button"
      ...
      <TableComponent :tableData="tableData" :fetchedData="userList" @call_to_refresh="fetchData" />
    </div>
    <ModalDialogs>
      <div>
        <div
        ...
        <ul class="list-disc pl-5 mb-5 text-xs">
          <li :class="{ 'text-green-600' : form.password.length >= 8 }">Длина пароля должна быть не менее 8 символов
          </li>
