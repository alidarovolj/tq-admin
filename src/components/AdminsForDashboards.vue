  ...
  <ul class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3" role="list">
    <li v-for="person in people" :key="person.email"
      ...
      <div class="flex w-full items-center justify-between space-x-6 p-6">
        ...
        <img :src="person.imageUrl" alt="" class="h-10 w-10 flex-shrink-0 rounded-full bg-gray-300"/>
      </div>
      <div>
        <div class="-mt-px flex divide-x divide-gray-200">
          <div class="flex w-0 flex-1">
            <a :href="`mailto:${person.email}`"
              ...
              <EnvelopeIcon aria-hidden="true" class="h-5 w-5 text-gray-400"/>
              Email
            </a>
          </div>
          <div class="-ml-px flex w-0 flex-1">
            <a :href="`tel:${person.telephone}`"
              ...
              <PhoneIcon aria-hidden="true" class="h-5 w-5 text-gray-400"/>
              Call
            </a>
          </div>
        </div>
